...
/*!
    ...
    with `i,j = u, v, w`. Be sure to respect the variances of `A` and `B`.
*/
template<> dIR3 contraction<first>(const ddIR3& A, const IR3& B) {
  return {
...
/*!
    ...
    with `i,j = u, v, w`. Be sure to respect the variances of `A` and `B`.
*/
template<> dIR3 contraction<second>(const ddIR3& A, const IR3& B) {
  return {
...
dIR3 contraction<first, first>(const dIR3& A, const dIR3& B) {
  return {
...
*/
template<contraction_index, contraction_index>
dIR3 contraction<second, first>(const dIR3& A, const dIR3& B) {
  return {
...
*/
template<contraction_index, contraction_index>
dIR3 contraction<second, second>(const dIR3& A, const dIR3& B) {
  return {
